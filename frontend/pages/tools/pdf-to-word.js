...
export default function PdfToWord() {
  ...
  const seoData = getSeoData('pdf-to-word');
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:5000/api/tools/pdf-to-word', {
        method: 'POST',
        body: formData
      });
      ...
      if (data.success) {
        ...
        a.href = url;
        a.download = data.filename || 'converted.docx';
        a.click();
      } else {
        // Show error with note about required libraries
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="mt-8 p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
                ...
                <p className="text-sm text-gray-300">
                  This feature requires additional backend implementation. PDF to Word conversion
                  will preserve text, formatting, and images from your PDF document.
                </p>
              </div>
            </div>
            ...
            <div className="mt-16 max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-gray-700">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Editable Format</h3>
                ...
                <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-gray-700">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Keep Images</h3>
                  <p className="text-gray-400 text-sm">
                    Extract and include images from PDF
                  </p>
                </div>
              </div>
            </div>
